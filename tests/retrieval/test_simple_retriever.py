...
from generic_rag.core.schemas import Chunk, RetrievalRequest
...
async def test_simple_retriever():
    ...
    chunk1 = Chunk(id="1", document_id="d1", chunk_index=0, content="match", start_char=0, end_char=5)
    chunk2 = Chunk(id="2", document_id="d2", chunk_index=0, content="no match", start_char=0, end_char=8)
